      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-contact">
            ...
            <ul>
              <li>
                <a href="mailto:shenoriperera87@gmail.com">
                  shenoriperera87@gmail.com
                </a>
              </li>
              <li>
                <a href="tel:+94712688576">+94 712 688 576</a>
              </li>
              <li>Wattala, Sri Lanka</li>
            </ul>
          </div>
        </div>

        <div className="footer-bottom">
          <p>&copy; {currentYear} Shenori Ruwesha. All Rights Reserved.</p>
