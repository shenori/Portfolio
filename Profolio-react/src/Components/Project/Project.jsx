  ...
  const projects = [
    {
      ...
      description:
        "A gamified learning platform designed to make coding education engaging and interactive. Features include coding challenges, progress tracking, and achievement systems.",
    ...
    },
    {
      ...
      description:
        "Led a team to create a comprehensive personal development website with features for goal tracking, habit building, and self-improvement resources.",
    ...
    },
    {
      ...
      description:
        "Python application for gathering and analyzing traffic data at two junctions, featuring data visualization and statistical analysis.",
    ...
    <section id="projects" className="projects">
      <div className="projects-container">
        ...
        <div className="projects-cta">
          <a
            href="https://github.com/ShenoriRuwesha"
            target="_blank"
